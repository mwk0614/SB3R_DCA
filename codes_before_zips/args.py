...
def make_args():
    ...
    # parser.add_argument("--model_dir", type=str, default="./SHREC2013/TARGET_MODELS/models_obj", help="CAD itself")
    ...
    # Rendering
    parser.add_argument("--rendering_silhouette", type=bool, default=False, help="Set True if you want to render silhouette, 2.5D information")
